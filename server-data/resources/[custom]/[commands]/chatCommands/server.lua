RegisterNetEvent('chatCommands:sendProximityMessage')
AddEventHandler('chatCommands:sendProximityMessage', function(playerId, title, message, color)
...
Citizen.CreateThread(function()
	TriggerEvent('chat:addSuggestion', '/twt',  _U("asdd"),  {{name = _U("asdsd"), help = _U("asdsad")}})
