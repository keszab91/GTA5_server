...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				--DrawAdvancedText(x,y ,w,h,scale, text, r,g,b,a,font,jus)
				--DrawAdvancedText(0.130 - x, 0.7 - y, 0.005, 0.0028, 0.6, mph, 255, 255, 255, 255, 6, 1)
				--DrawAdvancedText(0.174 - x, 0.7 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.2195 - x, 0.7 - y, 0.005, 0.0028, 0.6, "Fuel    " .. fuel, 255, 255, 255, 255, 6, 1)
				--DrawAdvancedText(0.148 - x, 0.7065 - y, 0.005, 0.0028, 0.4, "mp/h              km/h              Fuel", 255, 255, 255, 255, 6, 1)
				---DrawAdvancedText(0.148 - x, 0.7065 - y, 0.005, 0.0028, 0.4, " Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
